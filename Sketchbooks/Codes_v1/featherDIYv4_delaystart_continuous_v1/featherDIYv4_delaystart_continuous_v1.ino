...
// ===========================
// USER INPUTS (for delayed start continuous)
// ===========================
...
const int startDay = 22; // Day to start sampling
const int startHour = 12; // Hour to start sampling (24-hr format)
const int startMinute = 23; // Minute to start sampling
